...
- BLOCKED: 실제 Kakao JS 키/도메인, 운영 Supabase v2 사실 적재·Edge·권한·gateway, 실제 Pages 배포와 캐시 취소 전파는 아직 검증되지 않음. 지역 A/B·최근 증가 지점·전체 기관 페이지 등 남은 명세 차이는 `docs/implementation/verification-status.md`에 기록. 운영 DB·push·배포는 수행하지 않음.
