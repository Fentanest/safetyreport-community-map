...
3. **공개 표시에서만** 지역 접두어를 제거한다.
4. 남은 문자열의 1-based 위치 2,4,6의 문자(숫자·한글 모두)를 '*'로 치환한다.
...
| 123가4567 | 1*3*4*67 |
| 서울12가3456 | 1*가*4*6 |
| 경기 123가-4567 | 1*3*4*67 |

서울12가3456와 부산12가3456은 **서로 다른 canonical**이다. 마스킹 후 같다고 합치지 않는다.
